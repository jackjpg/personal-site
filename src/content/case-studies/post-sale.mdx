...
The post-sale experience touched almost every part of the business, but lacked a shared mental model. Every team had a different belief about how the flow worked, who owned what, and what "good" looked like. To align the organisation, I created a vision storyboard showing a four user types (seller, dealer, provider, driver).

Some of the hypotheses I explored included:

1. Buyer/driver profiles would reduce seller anxiety by increasing legitimacy and transparency at the highest-friction moment of the journey
2. Counteroffer tools would empower sellers to self-serve on price negotiations, reducing time to agree and the operational effort required from buyers
3. Time-based milestones would bring cohesion to the journey, lowering cancellation rates by setting clearer expectations and reducing ambiguity between steps
4. AI-assisted damage valuation could give sellers clearer justification for price changes and strengthen their negotiating position
...
I pitched the concept to the executive team, framing it as both a trust strategy and a growth opportunity. The idea gained buy-in and was adopted as an org-level priority. I worked with the head of product and an EM in translating the vision into a roadmap of smaller releases.
...
<V3Image 
  src="/Project_post-sale/mw_post-sale_intercept.png" 
